...
# violinplot
violinPlot(visium_giotto_object, feats = unique(topgenes_gini), cluster_column = 'leiden_clus',
...
# violinplot
violinPlot(visium_giotto_object, feats = unique(topgenes_scran), cluster_column = 'leiden_clus',
